...
const std::basic_regex<char> NOTE_OCT_REGEX = std::regex("[a-g][f|s]?[0-9]");
const std::basic_regex<char> NOTE_REGEX = std::regex("[a-g][f|s]?");
...
const std::map<std::string,uint16_t> noteIdx{{"c",0},{"cs",1},{"df",1},{"d",2},{"ds",3},{"ef",3},{"e",4},{"f",5},{"fs",6},{"gf",6},{"g",7},{"gs",8},{"af",8},{"a",9},{"as",10},{"bf",10},{"b",11}};
const std::vector<std::pair<uint16_t,std::string>> idxNote{{0,"c"},{1,"cs"},{1,"df"},{2,"d"},{3,"ds"},{3,"ef"},{4,"e"},{5,"f"},{6,"fs"},{6,"gf"},{7,"g"},{8,"gs"},{8,"af"},{9,"a"},{10,"as"},{10,"bf"},{11,"b"}};
